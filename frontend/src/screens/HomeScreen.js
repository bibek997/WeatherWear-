...
const styles = StyleSheet.create({
  ...
  location: { fontSize: 24, fontWeight: '700', color: '#FFFFFF', marginLeft: 8, flex: 1 },
  headerActions: { flexDirection: 'row', alignItems: 'center' },
  unitBadge: { backgroundColor: 'rgba(255, 255, 255, 0.2)', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.3)', marginRight: 12 },
  unitText: { fontSize: 12, fontWeight: '600', color: '#FFFFFF' },
  settingsButton: { padding: 6 },
  todayWeatherCard: { backgroundColor: '#FFFFFF', borderRadius: 20, marginHorizontal: 20, marginTop: -15, padding: 24, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 12, elevation: 5, borderWidth: 1, borderColor: '#F0F0F0' },
  todayWeatherHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 24 },
  todayWeatherIconContainer: { marginRight: 20 },
  todayIconBackground: { width: 80, height: 80, borderRadius: 40, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#F0F0F0' },
  todayWeatherInfo: { flex: 1 },
  todayTemperature: { fontSize: 48, fontWeight: '300', color: '#212121', letterSpacing: -1 },
  todayCondition: { fontSize: 18, fontWeight: '600', color: '#424242', marginTop: 4 },
  todayFeelsLike: { fontSize: 14, color: '#666', marginTop: 4, fontWeight: '500' },
  todayMetricsGrid: { flexDirection: 'row', justifyContent: 'space-between', borderTopWidth: 1, borderTopColor: '#F0F0F0', paddingTop: 20 },
  todayMetricCard: { alignItems: 'center', width: (width - 100) / 3 },
  todayMetricIcon: { width: 44, height: 44, borderRadius: 22, justifyContent: 'center', alignItems: 'center', marginBottom: 8 },
  todayMetricValue: { fontSize: 16, fontWeight: '700', color: '#212121', marginBottom: 2 },
  todayMetricLabel: { fontSize: 12, color: '#757575', fontWeight: '500' },
  section: { marginHorizontal: 20, marginTop: 24, marginBottom: 8 },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 16 },
  sectionTitle: { fontSize: 20, fontWeight: '700', color: '#212121', marginLeft: 12 },
  outfitGrid: { flexDirection: 'row', justifyContent: 'space-between', flexWrap: 'wrap' },
  outfitCard: { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 16, alignItems: 'center', width: (width - 60) / 2, marginBottom: 20, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 8, elevation: 2, borderWidth: 1, borderColor: '#F0F0F0' },
  emojiContainer: { width: 60, height: 60, borderRadius: 30, backgroundColor: '#F5F5F5', justifyContent: 'center', alignItems: 'center', marginBottom: 12, borderWidth: 1, borderColor: '#EEEEEE' },
  emoji: { fontSize: 32 },
  outfitLabel: { fontSize: 12, fontWeight: '600', color: '#757575', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 },
  outfitName: { fontSize: 14, fontWeight: '600', color: '#212121', textAlign: 'center', lineHeight: 18 },
  tipsContainer: { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 20, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 8, elevation: 2, borderWidth: 1, borderColor: '#F0F0F0' },
  tipItem: { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 12 },
  tipBullet: { marginRight: 12, marginTop: 2 },
  tipText: { flex: 1, fontSize: 15, color: '#424242', lineHeight: 22 },
  forecastTitleContainer: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  carouselIndicators: { flexDirection: 'row', alignItems: 'center', marginRight: 10 },
  indicatorDot: { width: 8, height: 8, borderRadius: 4, marginHorizontal: 3 },
  indicatorDotActive: { backgroundColor: '#007AFF', width: 12 },
  indicatorDotInactive: { backgroundColor: '#E0E0E0' },
  carouselContainer: { height: 435, marginBottom: 8 },
  carouselContent: { paddingHorizontal: (width - CARD_WIDTH) / 2 - CARD_SPACING, paddingVertical: 10 },
  carouselCardWrapper: { width: CARD_WIDTH, marginRight: CARD_SPACING },
  carouselHint: { fontSize: 12, color: '#666', textAlign: 'center', marginTop: 5, fontStyle: 'italic' },
  refreshButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFFFFF', marginHorizontal: 20, marginTop: 5, marginBottom: 25, paddingVertical: 16, borderRadius: 16, borderWidth: 1, borderColor: '#E0E0E0', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 1 },
  refreshIconContainer: { marginRight: 8 },
  refreshText: { fontSize: 14, color: '#007AFF', fontWeight: '600' },
});
